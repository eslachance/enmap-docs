...
* [Enmap](#Enmap) ⇐ <code>Map</code>
    * _instance_
        ...
        * [.fetch(keyOrKeys)](#Enmap+fetch) ⇒ [<code>Enmap</code>](#Enmap)
        ...
        * [.findKey(propOrFn, [value])](#Enmap+findKey) ⇒ <code>\*</code>
...
### enmap.fetch(keyOrKeys) ⇒ [<code>Enmap</code>](#Enmap)
Force fetch one or more key values from the enmap. If the database has changed, that new value is used.

**Kind**: instance method of [<code>Enmap</code>](#Enmap)  
**Returns**: [<code>Enmap</code>](#Enmap) - The Enmap, including the new fetched value(s).  
...
### enmap.findKey(propOrFn, [value]) ⇒ <code>\*</code>
